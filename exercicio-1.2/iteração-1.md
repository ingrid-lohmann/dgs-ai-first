Prompt: 
"Atue como um Engenheiro de Prompt Sênior. Preciso estruturar a documentação de Engenharia de Contexto e criar a Versão 1 do System Prompt para o assistente de IA da NovaTech (logística). 

Considere os seguintes guardrails obrigatórios do projeto:
...
Por favor, gere a resposta em Markdown com as seguintes duas seções:

### 1. Estrutura de Contexto
Mapeie a anatomia do contexto (o que é estático vs o que é dinâmico). Liste: System prompt, metadados, chunks recuperados, pergunta do usuário e histórico. Faça uma estimativa básica de tokens para cada parte, considerando um orçamento ideal para evitar "context overflow".

### 2. System Prompt - Versão 1
Escreva o prompt completo do sistema. Organize-o claramente em blocos:
- Identidade do assistente
- Regras de comportamento (guardrails)
- Formato de resposta exigido
- Instruções estritas para uso dos "chunks" de contexto.
- Regra de prioridade explícita: o que fazer se os documentos recuperados entrarem em conflito.

IMPORTANTE: Gere a resposta em um bloco de código especificando o nome do arquivo como `prototipo-prompt-v1.md`, para que eu possa salvá-lo diretamente."
